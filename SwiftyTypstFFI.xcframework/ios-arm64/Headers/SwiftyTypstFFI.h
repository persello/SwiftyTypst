...
RustBuffer ffi_SwiftyTypst_rustbuffer_from_bytes(ForeignBytes bytes, RustCallStatus *_Nonnull out_status
);
void ffi_SwiftyTypst_rustbuffer_free(RustBuffer buf, RustCallStatus *_Nonnull out_status
);
RustBuffer ffi_SwiftyTypst_rustbuffer_reserve(RustBuffer buf, int32_t additional, RustCallStatus *_Nonnull out_status
);
...
uint32_t ffi_SwiftyTypst_uniffi_contract_version(void
